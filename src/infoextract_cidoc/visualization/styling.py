...
def get_color_palette(
    ...
    *,
    ...
    palettes = {
        ...
        "pastel": ["#FFB3BA", "#FFDFBA", "#FFFFBA", "#BAFFC9", "#BAE1FF", "#E6BAFF", "#FFBAE6", "#FFE6BA"],
        "vibrant": ["#FF0000", "#00FF00", "#0000FF", "#FFFF00", "#FF00FF", "#00FFFF", "#FFA500", "#800080"],
        "muted": ["#8B4513", "#2F4F4F", "#483D8B", "#556B2F", "#8B008B", "#B22222", "#228B22", "#4682B4"],
        "grayscale": ["#000000", "#333333", "#666666", "#999999", "#CCCCCC", "#FFFFFF", "#808080", "#404040"],
    }
